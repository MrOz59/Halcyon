...
TiltedPhoques::UniquePtr<IGameLauncher> CreateGameLauncher(Strategy aStrategy)
{
    switch (aStrategy)
    {
    case Strategy::kExternalProcess: return TiltedPhoques::MakeUnique<ExternalProcessLauncher>();
    case Strategy::kInProcess:
    default: return TiltedPhoques::MakeUnique<InProcessLauncher>();
    }
}
